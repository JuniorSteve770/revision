// src/projects/Project0/components/Project0Navbar.js
...
const Project0Navbar = () => {
  return (
    <nav style={{ backgroundColor: '#f0f0f0', padding: '10px' }}>
      ...
      <Link to="/project0/page0" style={{ margin: '0 10px' }}>Options</Link>
      <Link to="/project0/page1" style={{ margin: '0 10px' }}>Opt-Vol</Link>
