...
const questions = {
  moyen: [
    // ==================== NIVEAU 1-2 : MATRICES (4 questions) ====================
    {
      question:
    ...
    // ==================== NIVEAU 1-2 : VOISINAGE (3 questions) ====================
    {
      question:
    ...
    },
    {
      ...
      options: [
        "Pour éviter une exception IndexOutOfRangeException",
        "Pour améliorer les performances",
        "Pour que le code soit plus lisible",
        "Pour éviter les boucles infinies",
      ],
      answer: "Pour éviter une exception IndexOutOfRangeException",
      explanation:
        "Sans vérification, un voisin en bordure sortirait de la grille et provoquerait une IndexOutOfRangeException. La vérification est indispensable.",
    },

    // ==================== NIVEAU 3 : DFS (3 questions) ====================
    {
      question:
    ...
    },
    {
      ...
      options: [
        ...
        "Résolution de labyrinthe et comptage d'îles",
        "Réseau social (degrés de séparation)",
        "Optimisation de coûts de transport",
      ],
      answer: "Résolution de labyrinthe et comptage d'îles",
      explanation:
    ...
    // ==================== NIVEAU 5 : FLOOD FILL (2 questions) ====================
    {
      question:
    ...
    // ==================== NIVEAU 6 : GRAPHES (2 questions) ====================
    {
      question:
        "[Graphes] Quelle est la représentation de graphe la plus efficace en mémoire pour un graphe peu dense ?",
      options: [
      ...
      explanation:
        "La liste d'adjacence ne stocke que les arêtes existantes. Pour un graphe peu dense, elle est beaucoup plus efficace en mémoire qu'une matrice d'adjacence.",
    },
    {
      question:
    ...
    },
    {
      ...
      explanation:
        "L'heuristique h(n) guide la recherche vers la destination. A* explore préférentiellement les noeuds proches de la cible, contrairement à Dijkstra.",
    },

    // ==================== NIVEAU 9 : BIDIRECTIONNEL (2 questions) ====================
    {
      question:
    ...
    },
    {
      ...
      answer: "Quand une cellule est visitée par les deux fronts",
      explanation:
    ...
    // ==================== NIVEAU 10 : NAVMESH (2 questions) ====================
    {
      question:
        "[NavMesh] Quelle est la structure de données utilisée par un NavMesh ?",
      options: [
        "Une grille de cases carrées",
        "Un ensemble de polygones convexes interconnectés",
        "Un arbre binaire de recherche",
        "Une liste chaînée de points",
      ],
      answer: "Un ensemble de polygones convexes interconnectés",
      explanation:
        "Un NavMesh décompose l'espace navigable en polygones convexes. Les personnages se déplacent à l'intérieur d'un polygone et passent d'un polygone à l'autre via leurs arêtes partagées.",
    },
    {
      question:
        "[NavMesh] Pourquoi le NavMesh est-il utilisé dans les jeux vidéo professionnels plutôt qu'une grille ?",
      options: [
        "Parce qu'il est plus simple à coder",
        "Pour des mouvements plus naturels et une meilleure précision",
        "Parce qu'il utilise moins de mémoire",
        "Parce qu'il est plus rapide à calculer",
      ],
      answer: "Pour des mouvements plus naturels et une meilleure précision",
      explanation:
        "Le NavMesh permet des mouvements en ligne droite réelle, sans les 'escaliers' des grilles. Il est plus précis et naturel pour les personnages 3D.",
    },
  ],
  avance: [
    // ==================== AVANCE (6 questions) ====================
    ...
    },
    {
      ...
      explanation:
        "JPS identifie les 'jump points' : les seuls noeuds où le chemin optimal peut changer de direction. Il ignore les noeuds intermédiaires, réduisant les noeuds explorés.",
    },
    {
      question:
        "[Avancé] Qu'est-ce que le 'backtracking' en DFS ?",
      options: [
        "Le fait d'aller toujours tout droit",
        "La capacité à revenir en arrière (annuler une décision) quand une branche échoue",
        "Le fait de mémoriser tous les chemins possibles",
        "La suppression des murs",
      ],
      answer: "La capacité à revenir en arrière (annuler une décision) quand une branche échoue",
      explanation:
        "Le backtracking est le mécanisme par lequel DFS annule la dernière décision (backtrack) quand une branche ne mène nulle part. C'est le fondement des solveurs de puzzles.",
    },
    {
      question:
        "[Avancé] Dans l'algorithme de Kahn (tri topologique), comment détecte-t-on un cycle ?",
      options: [
        "Si toutes les tâches ont des in-degree > 0",
        "Si le nombre de tâches dans l'ordre est inférieur au nombre total",
        "Si la file d'attente est vide avant la fin",
        "Si la file d'attente est pleine",
      ],
      answer: "Si le nombre de tâches dans l'ordre est inférieur au nombre total",
      explanation:
        "Si un cycle existe, certaines tâches auront toujours un in-degree > 0. À la fin, si ordre.Count < n, un cycle est détecté. Le projet est impossible.",
    },
  ],
  expert: [
    // ==================== PIEGES (4 questions) ====================
    ...
    },
    {
      ...
      explanation:
        "Chaque appel récursif ajoute un frame à la pile d'appels. Pour un grand labyrinthe, la pile peut déborder (StackOverflowException). Il faut utiliser la version itérative.",
    },
    {
      question:
      ...
      answer: "Queue est FIFO, PriorityQueue sort par priorité",
      explanation:
