...
const basicSlides = [
 {
  ...
  },
  {
    ...
    "answer": "**Problème résolu** : centraliser la création d'objets pour découpler le code client des implémentations concrètes et faciliter les évolutions. ◆ **Principes OOP** : Abstraction, Polymorphisme. ◆ **SOLID associé** : OCP, DIP. ◆ **Mots-clés C#** : `interface`, `abstract`, `switch`. ◆ **Pattern** : sélectionne l'implémentation adaptée selon le contexte. ◆ **Cas d'usage Natixis/Finance** : Stratégies de risque, connecteurs Bloomberg/Reuters. ◆ **⚠️ Confusion fréquente** : Factory ≠ Builder. Factory crée directement l'objet."
  },
  {
    "question": "Strategy — Changer d'algorithme dynamiquement | Natixis/Finance",
    "answer": "**Problème résolu** : remplacer un algorithme à l'exécution sans modifier le code métier qui l'utilise. ◆ **Principes OOP** : Polymorphisme. ◆ **SOLID associé** : OCP. ◆ **Mots-clés C#** : `interface`, injection. ◆ **Pattern** : plusieurs implémentations d'une même stratégie métier. ◆ **Cas d'usage Natixis/Finance** : Net Exposure, Gross Exposure, SA-CCR. ◆ **⚠️ Confusion fréquente** : Strategy choisit un algorithme, Factory crée un objet."
  },
  {
    "question": "Repository — Isoler l'accès aux données | Natixis/Finance",
    "answer": "**Problème résolu** : séparer la logique métier de l'accès aux données afin de faciliter la maintenance, les tests et les changements de base de données. ◆ **Principes OOP** : Abstraction. ◆ **SOLID associé** : DIP. ◆ **Mots-clés C#** : `interface`, `DbContext`. ◆ **Pattern** : interface métier + implémentation SQL ou Oracle. ◆ **Cas d'usage Natixis/Finance** : Trades, positions, expositions. ◆ **⚠️ Confusion fréquente** : Repository ≠ Facade."
  },
  {
    "question": "Builder — Construire des objets complexes | Natixis/Finance",
    "answer": "**Problème résolu** : construire progressivement des objets complexes comportant de nombreux paramètres sans créer des constructeurs illisibles. ◆ **Principes OOP** : Encapsulation. ◆ **SOLID associé** : SRP. ◆ **Mots-clés C#** : `Build()`, `WithX()`, Fluent Interface. ◆ **Pattern** : assemblage étape par étape avant création finale. ◆ **Cas d'usage Natixis/Finance** : Swaps, CDS, options complexes. ◆ **⚠️ Confusion fréquente** : Builder ≠ Factory. Builder construit progressivement."
  },
  {
    "question": "Facade — Simplifier un système complexe | Natixis/Finance",
    "answer": "**Problème résolu** : masquer la complexité d'un ensemble de services derrière une interface unique et simple à utiliser. ◆ **Principes OOP** : Encapsulation. ◆ **SOLID associé** : ISP. ◆ **Mots-clés C#** : orchestration, service unique. ◆ **Pattern** : point d'entrée unique vers plusieurs composants. ◆ **Cas d'usage Natixis/Finance** : moteur de pricing, risque et reporting FERMAT. ◆ **⚠️ Confusion fréquente** : Facade simplifie, Adapter traduit."
  },
  {
    "question": "Adapter — Connecter deux systèmes incompatibles | Natixis/Finance",
    "answer": "**Problème résolu** : permettre à deux systèmes ayant des interfaces différentes de collaborer sans modifier leur code existant. ◆ **Principes OOP** : Composition. ◆ **SOLID associé** : OCP. ◆ **Mots-clés C#** : wrapper, composition. ◆ **Pattern** : conversion entre une interface externe et une interface interne. ◆ **Cas d'usage Natixis/Finance** : Bloomberg Adapter, Reuters Adapter. ◆ **⚠️ Confusion fréquente** : Adapter traduit une interface, Facade la simplifie."
  },
  {
    "question": "Decorator — Ajouter des fonctionnalités dynamiquement | Natixis/Finance",
    "answer": "**Problème résolu** : enrichir le comportement d'un objet sans modifier sa classe d'origine en l'enveloppant dans un composant complémentaire. ◆ **Principes OOP** : Composition. ◆ **SOLID associé** : OCP. ◆ **Mots-clés C#** : wrapper, délégation. ◆ **Pattern** : ajout de fonctionnalités autour d'un composant existant. ◆ **Cas d'usage Natixis/Finance** : Audit, Logging, Cache. ◆ **⚠️ Confusion fréquente** : Decorator ajoute un comportement, Adapter change l'interface."
  },
  {
    "question": "Observer — Notification automatique | Natixis/Finance",
    "answer": "**Problème résolu** : notifier automatiquement plusieurs composants lorsqu'un événement ou un changement d'état se produit. ◆ **Principes OOP** : Polymorphisme. ◆ **SOLID associé** : OCP. ◆ **Mots-clés C#** : `event`, `delegate`, `Action`. ◆ **Pattern** : un sujet publie des événements vers plusieurs abonnés. ◆ **Cas d'usage Natixis/Finance** : alertes de risque, diffusion de prix de marché. ◆ **⚠️ Confusion fréquente** : Observer diffuse des événements, Strategy remplace un algorithme."
  },
  {
    "question": "Dependency Injection — Découpler les dépendances | Natixis/Finance",
    "answer": "**Problème résolu** : fournir les dépendances depuis l'extérieur afin de réduire le couplage, faciliter les tests et améliorer la modularité. ◆ **Principes OOP** : Abstraction. ◆ **SOLID associé** : DIP. ◆ **Mots-clés C#** : Constructor Injection, IoC Container. ◆ **Pattern** : les dépendances sont injectées plutôt que créées dans la classe. ◆ **Cas d'usage Natixis/Finance** : Repositories, stratégies de calcul, loggers. ◆ **⚠️ Confusion fréquente** : DI gère les dépendances, Factory crée les objets."
  }
];
