  ...
  return (
    <div className="results">
      ...
      {totalScore >= Math.floor(totalQuestions * 0.6)
        ? <h3 className="success">🚀 Excellent ! Comparaisons & Choix de modèles maîtrisés.</h3>
        : <p className="fail">📚 Révisez les comparaisons entre familles — c'est le cœur des entretiens ML.</p>
      }
    </div>
  );
};
