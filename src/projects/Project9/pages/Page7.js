...
const basicSlides = [
  ...
  },
  {
    ...
    answer:
      "◆ **Définition** : les 4 opérations fondamentales sur les données\n◆ **Create** : INSERT INTO\n◆ **Read** : SELECT\n◆ **Update** : UPDATE ... SET ... WHERE\n◆ **Delete** : DELETE FROM ... WHERE\n◆ **Piège** : oublier le WHERE sur un UPDATE/DELETE affecte TOUTES les lignes de la table\n◆ **Cas d'usage** : toujours tester un UPDATE/DELETE avec un SELECT équivalent avant de l'exécuter en production\n\n```sql\nUPDATE Orders SET Status = 'Canceled' WHERE OrderId = 123;\n```",
  },
  {
...
const questions = {
  moyen: [
    ...
    // ==================== SECTION E: CRUD ====================
    {
      question: "[CRUD] Quelle instruction correspond à l'opération 'Create' du CRUD ?",
      options: ["SELECT", "UPDATE", "INSERT INTO", "DELETE FROM"],
      answer: "INSERT INTO",
      explanation:
        "INSERT INTO correspond à la création (Create) d'une nouvelle ligne dans une table. SELECT = Read, UPDATE = Update, DELETE = Delete.",
    },
    {
